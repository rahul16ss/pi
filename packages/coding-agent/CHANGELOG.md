...
- Untracked file names are enumerated in full, then goal-path files are packed before the read cap, and omitted goal files emit `[... TRUNCATED: goal-relevant diff not fully shown ...]` so a checker cannot VERIFIED a file it never saw.
