...
import { clampMinThinkingLevel, SettingsManager, type VerifySettings } from "./settings-manager.ts";
...
export async function createAgentSession(options: CreateAgentSessionOptions = {}): Promise<CreateAgentSessionResult> {
	...
	// Enforce the configured thinking floor (covers CLI overrides, resumed
	// sessions, and the settings default alike)
	thinkingLevel = clampMinThinkingLevel(thinkingLevel, settingsManager.getMinThinkingLevel());
